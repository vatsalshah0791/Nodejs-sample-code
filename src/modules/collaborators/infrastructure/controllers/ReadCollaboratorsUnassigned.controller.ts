...
export default class ReadCollaboratorsUnassignedController {
    constructor(
    ...
    run = async (
        ...
        try {
            const readCollaboratorsUnassignedApplicationResult = await this.readCollaboratorsUnassignedApplication.run({ ...payload.params, selectIdAppRole: [4, 5, 6, 7] })
            req.apiResponse = {
